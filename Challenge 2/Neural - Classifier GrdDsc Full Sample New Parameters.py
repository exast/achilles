...
dnn_classifier = train_nn_classifier_model(
    ...
    periods = 4, #30
    batch_size= 15, #100
    hidden_units=[5,5,5,8], #[10, 10, 10]
    training_examples=training_examples,
    training_targets=training_targets,
    validation_examples=validation_examples,
    validation_targets=validation_targets,
    )
print("Model size:", model_size(dnn_classifier))
...
my_optimizer = tf.contrib.estimator.clip_gradients_by_norm(my_optimizer, 5.0) #taking away Clip Gradients
 
regularization_strength=0.0, #between 0.0 and 1.0
